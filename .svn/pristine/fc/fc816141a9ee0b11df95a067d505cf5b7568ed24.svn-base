...
/*
 *	find_char()
 *		Function:	Check if the given char is inside the given string
 *		Inputs:		str: string to search
 * 					c: char to look for
 *		Returns:	index of first match if found
 * 					otherwise -1 for fail

int32_t find_char(int8_t * str, char c){
	if (str == NULL)
		return -1;
